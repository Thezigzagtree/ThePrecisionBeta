...
Shader "CorrectShaderV5"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 color11 = IsGammaSpace() ? float4(0.9852941,0.7071933,0.1086721,0) : float4(0.9668716,0.4583007,0.01142176,0);
			...
			o.Albedo = ( ( tex2D( _TextureSample2, uv_TextureSample2 ) * color11 * clampResult33 ).rgb * ( ( ( (tex2D( _DetailAlbedo, uv_DetailAlbedo )).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) );
			float2 panner68 = ( 10.0 * float2( 0,0 ) + float2( 0,0 ));
			o.Metallic = panner68.x;
			float clampResult55 = clamp( abs( _SinTime.w ) , 0.2 , 0.6 );
			float3 temp_cast_2 = (clampResult55).xxx;
...
/*ASEBEGIN
Version=16800
-174;812;955;616;1799.128;376.7949;2.45;False;False
...
Node;AmplifyShaderEditor.ColorNode;11;-1539.551,-27.97956;Float;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;False;0;0.9852941,0.7071933,0.1086721,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;51;-1400.15,-484.7289;Float;True;Property;_TextureSample2;Texture Sample 2;13;0;Create;True;0;0;False;0;18b687e2045d542489ad43a7957c7805;18b687e2045d542489ad43a7957c7805;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;70;-1497.657,402.2703;Float;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;15;-876.8526,-100.7798;Float;False;Detail Albedo;9;;1;29e5a290b15a7884983e27c8f1afaa8c;0;3;12;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;9;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BlendOpsNode;36;-904.7919,596.6155;Float;True;Exclusion;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.AbsOpNode;79;-1457.657,702.2703;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CosTime;85;-1676.657,702.2703;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PannerNode;76;-1175.657,383.2703;Float;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=3885F935A50629CD9651CCE70FBCBE98595B1B37